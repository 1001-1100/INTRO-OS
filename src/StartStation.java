 ...
 */
	...
	public void addLeftPassenger() {
		...
		leftPassenger.setIcon(new ImageIcon(Interface.class.getResource("/A2MoveRight.png")));
	...
	public void addRightPassenger() {
		...
		rightPassenger.setIcon(new ImageIcon(Interface.class.getResource("/A2MoveLeft.png")));
